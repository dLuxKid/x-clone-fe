...
export default function RightSidebar() {
  return (
    <section className="sticky top-2 hidden lg:flex flex-col space-y-4 h-[98vh] min-w-[275px] w-full max-w-[392px] pr-6 pl-4 overflow-scroll right-section mr-auto">
      <div className="relative h-full w-full">
        ...
        <label
          htmlFor="searchBox"
          className="absolute top-0 left-4 h-full flex items-center justify-center text-gray-500 peer-focus:text-blue-pry"
        >
            ...
            >
              ...
              <div>
                <button
                  title="follow"
                  type="button"
                  className="rounded-full px-6 py-2 bg-white text-neutral-950 font-semibold hover:opacity-80"
                >
                  Follow
                </button>
              </div>
